...
final readonly class AgentCostReport
{
    ...
    public function __construct(
        ...
        public int $llmCallsToday,
        public int $cacheReadTokensToday,
        public int $cacheCreationTokensToday,
        public int $avgQueueDelayMsToday,
        public int $avgLlmDurationMsToday,
        public int $avgLlmTtftMsToday,
