...
final class ElectronicsDemoData
{
    ...
    public const array PRODUCT_CATEGORIES = [
        'smartfony' => ['label' => ['pl' => 'Smartfony', 'en' => 'Smartphones'], 'parent' => null, 'count' => 120, 'hue' => 210, 'price' => [899, 6999], 'weight' => [0.15, 0.25], 'specs' => ['display', 'computing', 'mobile'], 'screen' => [6.1, 6.9], 'os' => 'android', 'models' => ['Voltix Nova X2', 'Voltix Nova A5', 'Aurion Prime 15', 'Aurion Prime 14', 'Orbitek Halo N13', 'Tarvos Lumen 8', 'Nuvano Flux 12', 'Rivelo Arc 50']],
        'laptopy' => ['label' => ['pl' => 'Laptopy', 'en' => 'Laptops'], 'parent' => null, 'count' => 110, 'hue' => 260, 'price' => [1999, 12999], 'weight' => [1.1, 2.8], 'specs' => ['display', 'computing'], 'screen' => [13.0, 17.0], 'os' => 'windows', 'models' => ['Vantor Taskline T14', 'Vantor Flowbook 5', 'Helvion Apex 13', 'Helvion Breeze 16', 'Corvano Vertex 840', 'Corvano Sonata 15', 'Aurion Aria M3', 'Kitara Breve 14', 'Ostren Motiva 5']],
        'tablety' => ['label' => ['pl' => 'Tablety', 'en' => 'Tablets'], 'parent' => null, 'count' => 60, 'hue' => 190, 'price' => [599, 5499], 'weight' => [0.3, 0.7], 'specs' => ['display', 'computing', 'mobile'], 'screen' => [8.0, 13.0], 'os' => 'android', 'models' => ['Voltix Nova Tab T9', 'Aurion Slate Air', 'Aurion Slate 10', 'Vantor Tab V12', 'Orbitek Pad P6']],
        'telewizory' => ['label' => ['pl' => 'Telewizory', 'en' => 'TVs'], 'parent' => null, 'count' => 90, 'hue' => 0, 'price' => [1299, 14999], 'weight' => [8.0, 35.0], 'specs' => ['display'], 'screen' => [43.0, 85.0], 'models' => ['Voltix Quantum Q80', 'Lumetra OLED L4', 'Kyodo Horizon X90', 'Tarvos CV74', 'Glowen Aura 808']],
        'monitory' => ['label' => ['pl' => 'Monitory', 'en' => 'Monitors'], 'parent' => null, 'count' => 70, 'hue' => 30, 'price' => [499, 4999], 'weight' => [3.0, 9.0], 'specs' => ['display'], 'screen' => [24.0, 34.0], 'models' => ['Vantor ClearView CV27', 'Lumetra GameLine GL27', 'Voltix Vortex V7', 'Ostren ViewLite VL27', 'Prismo PV27']],
        'audio' => ['label' => ['pl' => 'Audio', 'en' => 'Audio'], 'parent' => null, 'count' => 0, 'hue' => 120, 'price' => [0, 0], 'weight' => [0.0, 0.0], 'specs' => [], 'models' => []],
        'sluchawki' => ['label' => ['pl' => 'Słuchawki', 'en' => 'Headphones'], 'parent' => 'audio', 'count' => 80, 'hue' => 130, 'price' => [99, 1899], 'weight' => [0.05, 0.4], 'specs' => ['audio'], 'models' => ['Kyodo NC-X5', 'Nordwave Hush 45', 'Aurion Buds Pro 2', 'Sonique Tempo 770', 'Klangwerk Motiv 4']],
        'glosniki' => ['label' => ['pl' => 'Głośniki', 'en' => 'Speakers'], 'parent' => 'audio', 'count' => 60, 'hue' => 150, 'price' => [149, 2999], 'weight' => [0.5, 5.0], 'specs' => ['audio'], 'models' => ['Sonique Surge 5', 'Auralon Uno SL', 'Rockmere Harlow III', 'Nordwave Pulse 500', 'Tempesta Squall XL']],
        'foto' => ['label' => ['pl' => 'Fotografia', 'en' => 'Photography'], 'parent' => null, 'count' => 0, 'hue' => 280, 'price' => [0, 0], 'weight' => [0.0, 0.0], 'specs' => [], 'models' => []],
        'aparaty' => ['label' => ['pl' => 'Aparaty', 'en' => 'Cameras'], 'parent' => 'foto', 'count' => 60, 'hue' => 290, 'price' => [1999, 15999], 'weight' => [0.3, 1.2], 'specs' => ['photo'], 'models' => ['Optaris Vega VR40', 'Veylor ZR5', 'Kyodo AR64', 'Argenta XM-30 II', 'Lumetra GX10']],
        'gaming' => ['label' => ['pl' => 'Gaming', 'en' => 'Gaming'], 'parent' => null, 'count' => 0, 'hue' => 330, 'price' => [0, 0], 'weight' => [0.0, 0.0], 'specs' => [], 'models' => []],
        'konsole' => ['label' => ['pl' => 'Konsole', 'en' => 'Consoles'], 'parent' => 'gaming', 'count' => 50, 'hue' => 340, 'price' => [999, 3499], 'weight' => [1.5, 4.5], 'specs' => ['computing'], 'os' => 'none', 'models' => ['Kyodo Arcadia 5', 'Kyodo Arcadia 5 Digital', 'Vantor Ludex X', 'Vantor Ludex S', 'Kodama Flip OLED']],
        'smartwatche' => ['label' => ['pl' => 'Smartwatche', 'en' => 'Smartwatches'], 'parent' => null, 'count' => 70, 'hue' => 50, 'price' => [299, 3999], 'weight' => [0.03, 0.09], 'specs' => ['display', 'mobile'], 'screen' => [1.2, 2.0], 'models' => ['Aurion Watch A9', 'Voltix Nova Watch 6', 'Trailon Stride 3', 'Rivelo Watch R4', 'Nuvano Fit 4']],
        'agd' => ['label' => ['pl' => 'AGD', 'en' => 'Home appliances'], 'parent' => null, 'count' => 0, 'hue' => 90, 'price' => [0, 0], 'weight' => [0.0, 0.0], 'specs' => [], 'models' => []],
        'lodowki' => ['label' => ['pl' => 'Lodówki', 'en' => 'Refrigerators'], 'parent' => 'agd', 'count' => 50, 'hue' => 95, 'price' => [1499, 8999], 'weight' => [55.0, 120.0], 'specs' => ['appliance'], 'models' => ['Voltix FR38', 'Presco KF39', 'Lumetra GB72', 'Grunwerk GX82', 'Tessano B5R405']],
        'pralki' => ['label' => ['pl' => 'Pralki', 'en' => 'Washing machines'], 'parent' => 'agd', 'count' => 50, 'hue' => 100, 'price' => [1199, 4999], 'weight' => [60.0, 85.0], 'specs' => ['appliance'], 'models' => ['Presco WM2800', 'Voltix XW90', 'Lumetra FW340', 'Grunwerk WB8200', 'Elmarra EF6300']],
        'odkurzacze' => ['label' => ['pl' => 'Odkurzacze', 'en' => 'Vacuum cleaners'], 'parent' => 'agd', 'count' => 50, 'hue' => 110, 'price' => [299, 3599], 'weight' => [1.5, 8.0], 'specs' => ['appliance'], 'models' => ['Vortalis VX15 Sense', 'Orbitek GV10 Plus', 'Tavella FlexForce X', 'Glowen RapidPro Max', 'Presco Unbound 7']],
        'akcesoria' => ['label' => ['pl' => 'Akcesoria', 'en' => 'Accessories'], 'parent' => null, 'count' => 50, 'hue' => 20, 'price' => [29, 899], 'weight' => [0.05, 1.0], 'specs' => [], 'models' => ['Craftono GlidePro 3S', 'Tastora T8 Pro', 'Voltix PowerPack 20000', 'Chargio BoostLine 65W', 'Memvia Max 128GB', 'Portena Hub USB-C 8w1']],
        'siec' => ['label' => ['pl' => 'Sieć i internet', 'en' => 'Networking'], 'parent' => null, 'count' => 0, 'hue' => 170, 'price' => [0, 0], 'weight' => [0.0, 0.0], 'specs' => [], 'models' => []],
        'routery' => ['label' => ['pl' => 'Routery', 'en' => 'Routers'], 'parent' => 'siec', 'count' => 30, 'hue' => 175, 'price' => [149, 1999], 'weight' => [0.3, 1.2], 'specs' => ['network'], 'models' => ['Zephyr Tech WR55', 'Kitara RT-X58', 'Netrelia Falcon RX43', 'Orbitek AXR32', 'Aerix MeshOne Router']],
    ];
