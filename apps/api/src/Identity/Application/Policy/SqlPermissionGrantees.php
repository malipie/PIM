...
/**
 * WFL-P2-02 (#2421) — reverse permission lookup over the role
 * assignments. Raw DBAL with an explicit tenant filter — same read-model
 * pattern as the Dashboard aggregates (ADR-0026); RLS backstops raw
 * access. ADR-0034 (#2832) collapsed the previous UNION over the legacy
 * `user_roles` M2M into this single source.
 *
