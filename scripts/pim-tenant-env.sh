...
# URL (postgresql://user:haslo@host/db), więc znak `@`, `:`, `/` albo `#`
# z base64 rozerwałby połączenie w sposób trudny do zdiagnozowania. Wyjątkiem
# jest APP_BYOK_KEY_V1, którego aplikacja oczekuje w base64 i który nigdy nie
# ląduje w URL-u.
